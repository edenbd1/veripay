    ...
    <div>
      ...
      <div className="space-y-2">
        {SAMPLE_PDFS.map((s) => (
          ...
          >
            <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-black/5 font-mono text-[10px] font-bold text-foreground">
              PDF
            </div>
            ...
            <span className="shrink-0 rounded-full bg-black/5 px-2.5 py-0.5 text-[10px] font-medium text-muted">
