...
export function FileDropZone({
  ...
  return (
    ...
    >
      ...
      {file ? (
        <>
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-foreground/5 dark:bg-foreground/10">
        ...
        <>
          ...
          <p className="mt-1 text-xs text-muted">ou cliquez pour selectionner (max 10 Mo)</p>
        </>
      )}
    </div>
  );
